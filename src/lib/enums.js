...
export const updates = {
    CLOSE_RU: 'Закрыть',
    CLOSE_ENG: 'Close',
    UPDATES_RU: "Последние обновления",
    UPDATES_ENG: "Latest Updates"
}